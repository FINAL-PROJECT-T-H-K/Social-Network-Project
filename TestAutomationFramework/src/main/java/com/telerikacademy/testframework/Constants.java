...
public class Constants {
    ...
    public static String USERNAME_SENDER_UI;
    public static String PASSWORD_SENDER_UI;
    public static String PASSWORD_RECEIVER_UI;
    public static String USERNAME_RECEIVER_UI;
